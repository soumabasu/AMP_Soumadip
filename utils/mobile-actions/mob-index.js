const verifyElementIsDisplayed = require('@deloitte/web/utils/mobile-actions/mob-element-status')
...
const click_coordinates = require('@deloitte/web/utils/mobile-actions/mob-click_coordinates')
